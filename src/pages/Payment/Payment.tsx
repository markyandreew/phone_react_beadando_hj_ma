        ...
        <form className={styles.form} onSubmit={urlap}>
          <label className={styles.labelText}>
            ...
            <input
              ...
              value={nev}
              onChange={(esemeny) => setNev(esemeny.target.value)}
              required
            />
          </label>
          ...
          <label className={styles.labelText}>
            ...
            <input
              className={styles.inputField}
              value={email}
              onChange={(esemeny) => setEmail(esemeny.target.value)}
              required
            />
          </label>
          ...
          <label className={styles.labelText}>
            ...
            <input
              className={styles.inputField}
              value={cim}
              onChange={(esemeny) => setCim(esemeny.target.value)}
              required
            />
          </label>
          ...
          <button
            className={styles.fizetesButton}
            disabled={osszeg === 0}
            type="submit"
          >
            Fizetés
