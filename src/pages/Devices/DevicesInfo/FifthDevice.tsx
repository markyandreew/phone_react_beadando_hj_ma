...
import device1 from "../../../assets/device5Front.jpg"
import device2 from "../../../assets/device5Side.jpg"
...
const FifthhDevice: React.FC = () => {
  ...
  <div className={styles.balOldal}>
    <header className={styles.infoHeader}>Samsung React</header>
  ...
  <section className={styles.infosection}>
    ...
    <br />
    <br />
    <p className={styles.arCimke}>310 000 Ft</p>
